...
message("!!!!==========Config debug target:${QT_VERSION_MAJOR}")
# Import target "SARibbon" for configuration "Debug"
set_property(TARGET SARibbon APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(SARibbon PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libSARibbon.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "Qt${QT_VERSION_MAJOR}::Widgets"
  IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/SARibbon.dll"
  )
...
# Import target "QCustomPlot" for configuration "Debug"
set_property(TARGET QCustomPlot APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(QCustomPlot PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libQCustomPlot.dll.a"
  ...
  IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/QCustomPlot.dll"
  )
...
# Import target "AuraUIWidget" for configuration "Debug"
set_property(TARGET AuraUIWidget APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(AuraUIWidget PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libAuraUIWidget.dll.a"
  ...
  IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/AuraUIWidget.dll"
  )
...
# Import target "Aura3DGraphics" for configuration "Debug"
list (APPEND Aura3DGraphics_Link_debug 
...
set_property(TARGET Aura3DGraphics APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(Aura3DGraphics PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libAura3DGraphics.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "${Aura3DGraphics_Link_debug}"
  ...
  IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/Aura3DGraphics.dll"
  )
...
# Import target "AuraPixture" for configuration "Debug"
# set_property(TARGET AuraPixture APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
# set_target_properties(AuraPixture PROPERTIES
#   IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libAuraPixture.dll.a"
#   IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "QT${QT_VERSION_MAJOR}::Core;QT${QT_VERSION_MAJOR}::Gui;QT${QT_VERSION_MAJOR}::Widgets"
#   IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/AuraPixture.dll"
#   )
...
# Import target "AuraProperty" for configuration "Debug"
# set_property(TARGET AuraProperty APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
# set_target_properties(AuraProperty PROPERTIES
#   IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libAuraProperty.dll.a"
#   IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "QT${QT_VERSION_MAJOR}::Core"
#   IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/AuraProperty.dll"
#   )
...
# Import target "AuraAlgorithm" for configuration "Debug"
# set_property(TARGET AuraAlgorithm APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
# set_target_properties(AuraAlgorithm PROPERTIES
#   IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libAuraAlgorithm.dll.a"
#   IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "QT${QT_VERSION_MAJOR}::Core;QT${QT_VERSION_MAJOR}::Gui"
#   IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/AuraAlgorithm.dll"
#   )
...
# Import target "AuraAlgorithm" for configuration "Debug"
set_property(TARGET AuraTool APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(AuraTool PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libAuraTool.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "QT${QT_VERSION_MAJOR}::Core;QT${QT_VERSION_MAJOR}::Gui"
  IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/AuraTool.dll"
  )
...
# Import target "Aura2DChart" for configuration "Debug"
set_property(TARGET Aura2DChart APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(Aura2DChart PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libAura2DChart.dll.a"
  ...
  IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/Aura2DChart.dll"
  )
...
# Import target "AuraLibrary" for configuration "Debug"
list (APPEND AuraLibrary_Link_debug 
...
set_property(TARGET AuraLibrary APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(AuraLibrary PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/arc/libAuraLibrary.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "${AuraLibrary_Link_debug}"
  ...
  IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/bin/AuraLibrary.dll"
  )
...
# Import target "AuraLibraryStatic" for configuration "Debug"
set_property(TARGET AuraLibraryStatic APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(AuraLibraryStatic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${CMAKE_CURRENT_LIST_DIR}/lib/AuraLibrary.a"
  )
