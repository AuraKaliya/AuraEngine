...
add_library(AuraLibraryStatic STATIC IMPORTED)

#message("####++++++++Config target: ${QT_VERSION_MAJOR}")
list(APPEND AuraLibraryStatic_Link 
"\$<LINK_ONLY:Qt${QT_VERSION_MAJOR}::Widgets>"
"\$<LINK_ONLY:Qt${QT_VERSION_MAJOR}::PrintSupport>"
"\$<LINK_ONLY:Qt${QT_VERSION_MAJOR}::Core>"
...
list(APPEND AuraLibraryStatic_Link 
"\$<LINK_ONLY:Qt${QT_VERSION_MAJOR}::OpenGLWidgets>"
"\$<LINK_ONLY:Qt${QT_VERSION_MAJOR}::OpenGL>"
)
else()
list(APPEND AuraLibraryStatic_Link 
"\$<LINK_ONLY:Qt${QT_VERSION_MAJOR}::OpenGL>"
...
set_target_properties(AuraLibraryStatic PROPERTIES
  INTERFACE_LINK_LIBRARIES "${AuraLibraryStatic_Link}"
)

file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/AuraLibraryTargets-Import.cmake")
